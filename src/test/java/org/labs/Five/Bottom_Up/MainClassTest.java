...
class MainClassTest_Bottom_Up {
    ...
    void testMainWithYesInput() {
        ...
        assertTrue(outContent.toString().contains("Wants to Start Machine Y or N ?"));
        assertTrue(outContent.toString().contains("Successfully brewed Black Coffee"));
    ...
    void testMainWithSmallYInput() {
        ...
        // Check if the appropriate messages are displayed and that the machine starts
        assertTrue(outContent.toString().contains("Wants to Start Machine Y or N ?"));
        assertTrue(outContent.toString().contains("Successfully brewed Milk Coffee"));
        assertTrue(outContent.toString().contains("Shutting Down..."));
    }
    ...
    void testMainWithNoInput() {
        ...
        assertTrue(outContent.toString().contains("Wants to Start Machine Y or N ?"));
        assertFalse(outContent.toString().contains("Successfully brewed"));
        assertTrue(outContent.toString().contains("Shutting Down..."));
    }
